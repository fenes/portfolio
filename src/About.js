...
const useStyles = makeStyles(theme => ({
    ...
    avatar: {
        height: 32,// theme.spacing(8),
        width: 32, //theme.spacing(8),
        padding: 6 // theme.spacing(2)
    },
    dp: {
                            ...
                            <Grid item key={i}>
                                <a href={link} target="_blank" rel="noopener noreferrer">
                                    <Tooltip title={alt} placement="top">
                                        <Avatar sx={{ width: 12, height: 12 }} variant="rounded" className={clsx([classes.avatar, classes[alt]])}>
                                            {icon}
                                        </Avatar>
                                    </Tooltip>
                                </a>
